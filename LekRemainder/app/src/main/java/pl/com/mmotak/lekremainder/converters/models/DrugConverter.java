...
public class DrugConverter {
    ...
    private static DateTimeFormatter normalDateTimeFormatter = DateTimeFormat.forPattern(dbDateTimeFormat);
    ...
    private static DateTime parse(String dateTime) {
        ...
        return normalDateTimeFormatter.parseDateTime(dateTime);
    }
}
